  ...
  prepareRunRetry(taskId, runIndex) {
    return Task.updateOne({ _id: taskId }, {
      ...
      $unset: {
        ...
        [`runs.${runIndex}.cookieSetName`]: "",
        [`runs.${runIndex}.cookieSetIndex`]: "",
        [`runs.${runIndex}.cookieSetCount`]: "",
        [`runs.${runIndex}.cookiePoolId`]: "",
        [`runs.${runIndex}.proxyHost`]: "",
        [`runs.${runIndex}.proxyExitIp`]: "",
        [`runs.${runIndex}.proxyExitIpError`]: "",
